...
## Описание проекта
**Proxmox Monitor** — это веб-приложение для мониторинга кластера Proxmox VE в реальном времени. Приложение предоставляет удобный интерфейс для отслеживания состояния узлов, хранилищ, заданий резервного копирования и общего состояния кластера.
## Возможности
### Основные функции
