...
<div class="tab-pane fade show active" role="tabpanel">
    <div class="settings-section">
        ...
        <div class="mb-4">
            <div class="threshold-label d-flex justify-content-between"><span>CPU Green Up To</span><span>70%</span></div>
            <input type="range" class="form-range threshold-slider" min="0" max="100" value="70">
        </div>
        <div class="mb-4">
            <div class="threshold-label d-flex justify-content-between"><span>CPU Yellow Up To</span><span>90%</span></div>
            <input type="range" class="form-range threshold-slider" min="0" max="100" value="90">
        </div>
        <div class="mb-4">
            <div class="threshold-label d-flex justify-content-between"><span>RAM Green Up To</span><span>70%</span></div>
            <input type="range" class="form-range threshold-slider" min="0" max="100" value="70">
        </div>
        <div class="mb-4">
            <div class="threshold-label d-flex justify-content-between"><span>RAM Yellow Up To</span><span>90%</span></div>
            <input type="range" class="form-range threshold-slider" min="0" max="100" value="90">
        </div>
        <div class="text-end">
...
const buildNormalPage = (page) => {
    ...
    if (page.key === 'speedtest') return pageShell('HomeLab Monitor Demo Speedtest', normalScreenSection('speedtestMonitorSection', 'Speedtest', 'speedometer2', speedtestPanel));
    return '';
};
